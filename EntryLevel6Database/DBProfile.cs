...
namespace EntryLevel6Database
{
    ...
    namespace DatabaseProject
    {
        class DBProfile
        {
            ...
            private static string strConnString = "Data Source=Archangel;Initial Catalog=\"76768977154C04B69333E7092345E2C7_TUDIES\\DATABASE MANAGEMENT\\FORMS DATABASE\\ENTRYLEVEL6DATABASE\\ENTRYLEVEL6DATABASE\\DATABASE1.MDF\";Integrated Security=True";
            ...
            public int executeQuery(SqlCommand dbCommand)
            {
                ...
                {
                    MessageBox.Show("Error While Upload");
                    throw ex;
